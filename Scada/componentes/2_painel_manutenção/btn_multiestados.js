...
s += "<button " + (isDisabled1 ? "disabled " : "") + "style='padding: 6px 10px; box-shadow: 2px 2px 0 0; border-radius: 8px; font-weight: bold; font-size: 12px; transition: background-color 0.3s, color 0.3s; ";
