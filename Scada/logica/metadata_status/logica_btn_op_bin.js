...
if (energ.value == 0 && btn_atencao.value == 1) {
    if (status_man.value == 2 || status_man.value == 3) {
        return 7
    }
    return 5
} else if ((energ.value == 0 || energ.value == 1) && btn_emerg.value == 1) {
    if (status_man.value == 2 || status_man.value == 3) {
        return 7
    }
    return 6
} else if ((energ.value == 0) && btn_ok.value == 1) {
    if (status_man.value == 2 || status_man.value == 3){
        return 7
    }
    return 0
} else {
    if (btn_ok.value == 0 && btn_atencao.value == 0 && btn_emerg.value == 0 && btn_man.value == 0 && on_off.value == 0) {
        ...
        return 6 // Emergencia
    } else if ((on_off.value == 1 || on_off.value == 0) && (status_man.value == 2 || status_man.value == 3)){
        return 7 // Manutenção
    } else {
        return 8 // ERRO
    }
